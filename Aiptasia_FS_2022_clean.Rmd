...
pheatmap(as.matrix(explc_nfkb_apo),
         ...
         scale="none",
         legend=T)
#saved as pheatmap_nfkb_apo_012223.pdf as portrait with 6x4 dimensions in Figures
```
...
pheatmap(as.matrix(explc_nfkb_sym),
         ...
         scale="none",
         legend=F)
#saved as pheatmap_nfkb_sym_012223.pdf as portrait with 6x4 dimensions in Figures
```
...
pheatmap(as.matrix(explc_rosd_apo),
         ...
         scale="none",
         legend=T)
#saved as pheatmap_ros_apo_012223.pdf as portrait with 6x4 dimensions in Figures
```
...
pheatmap(as.matrix(explc_rosd_sym),
         ...
         scale="none",
         legend=F)
#saved as pheatmap_ros_sym_012223.pdf as portrait with 5x4 dimensions in Figures
```
