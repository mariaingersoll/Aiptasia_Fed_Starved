...
```{r}
apoSup10_cleves1 <- apo_Sup10 %>%
  inner_join(cleves_1)
nrow(apoSup10_cleves1)
#29
head(apoSup10_cleves1)
apo_cleves_names = apoSup10_cleves1 %>%
  distinct(gene_ID, .keep_all = TRUE) %>%
  left_join(gene) %>%
  mutate(gene_symbol = make.names(gene_symbol, unique = TRUE)) %>%
  column_to_rownames(var = "gene_symbol") %>%
  ...
  dplyr::select(sort(tidyselect::peek_vars()))
head(apo_cleves_names)
nrow(apo_cleves_names)
#29
apo_cleves_means = apply(apo_cleves_names, 1, mean)
explc_apo_cleves = apo_cleves_names-apo_cleves_means

pheatmap(as.matrix(explc_apo_cleves),
         color=rev(colorRampPalette(brewer.pal(n=11, name="RdBu"))(20)),
         cluster_rows = T, show_rownames = T, fontsize_row=8, fontsize_col=10, treeheight_row = 10, treeheight_col = 10,
         ...
         scale="none",
         legend=T) 
#saved as apo_nfkb_sites_cleves_060323.pdf as portrait with 5x4 in Figures

symSup10_cleves1 <- sym_Sup10 %>%
  inner_join(cleves_1)
nrow(symSup10_cleves1)
#16
head(symSup10_cleves1)
sym_cleves_names = symSup10_cleves1 %>%
  distinct(gene_ID, .keep_all = TRUE) %>%
  left_join(gene) %>%
  mutate(gene_symbol = make.names(gene_symbol, unique = TRUE)) %>%
  column_to_rownames(var = "gene_symbol") %>%
  ...
  dplyr::select(sort(tidyselect::peek_vars()))
head(sym_cleves_names)
nrow(sym_cleves_names)
#16

sym_cleves_means = apply(sym_cleves_names, 1, mean)
explc_sym_cleves = sym_cleves_names-sym_cleves_means
...
pheatmap(as.matrix(explc_sym_cleves),
         color=rev(colorRampPalette(brewer.pal(n=11, name="RdBu"))(20)),
         cluster_rows = T, show_rownames = T, fontsize_row=8, fontsize_col=10, treeheight_row = 10, treeheight_col = 10,
         cluster_cols = T, show_colnames = T, clustering_callback=callback, angle_col= "315", cellheight = 8, cellwidth = 14,
         breaks=c(seq(from=-1,to=1,by=0.1)),
         scale="none",
         legend=F) 
#saved as sym_nfkb_sites_cleves_060323.pdf as portrait with 5x4 in Figures
```

Analyze your data against the Cleves data set with 3 or more sites
```{r}
apoSup10_cleves3 <- apo_Sup10 %>%
  inner_join(cleves_3)
nrow(apoSup10_cleves3)
#14
head(apoSup10_cleves3)
apo_cleves_names3 = apoSup10_cleves3 %>%
  distinct(gene_ID, .keep_all = TRUE) %>%
  left_join(gene) %>%
  mutate(gene_symbol = make.names(gene_symbol, unique = TRUE)) %>%
  column_to_rownames(var = "gene_symbol") %>%
  dplyr::select(-pval.AS_AF, -padj.AS_AF, -apo_lfc, -NFKB_sites, -Log2FC_SYM_0_3h, -padj_SYM_0_3h, -Log2FC_APO_0_3h, -padj_APO_0_3h, -gene_ID, -accession, -description) %>%
  dplyr::select(sort(tidyselect::peek_vars()))
head(apo_cleves_names3)
nrow(apo_cleves_names3)
#14
apo_cleves_means3 = apply(apo_cleves_names3, 1, mean)
explc_apo_cleves3 = apo_cleves_names3-apo_cleves_means3

pheatmap(as.matrix(explc_apo_cleves3),
         color=rev(colorRampPalette(brewer.pal(n=11, name="RdBu"))(20)),
         cluster_rows = T, show_rownames = T, fontsize_row=8, fontsize_col=10, treeheight_row = 10, treeheight_col = 10,
         cluster_cols = T, show_colnames = T, angle_col= "315", cellheight = 8, cellwidth = 14,
         breaks=c(seq(from=-1,to=1,by=0.1)),
...
symSup10_cleves3 <- sym_Sup10 %>%
  inner_join(cleves_3)
nrow(symSup10_cleves3)
#7
head(symSup10_cleves3)
sym_cleves_names3 = symSup10_cleves3 %>%
  distinct(gene_ID, .keep_all = TRUE) %>%
  left_join(gene) %>%
  mutate(gene_symbol = make.names(gene_symbol, unique = TRUE)) %>%
  column_to_rownames(var = "gene_symbol") %>%
  dplyr::select(-pval.SS_SF, -padj.SS_SF, -sym_lfc, -NFKB_sites, -Log2FC_SYM_0_3h, -padj_SYM_0_3h, -Log2FC_APO_0_3h, -padj_APO_0_3h, -gene_ID, -accession, -description) %>%
  dplyr::select(sort(tidyselect::peek_vars()))
head(sym_cleves_names3)
nrow(sym_cleves_names3)
#7

sym_cleves_means3 = apply(sym_cleves_names3, 1, mean)
explc_sym_cleves3 = sym_cleves_names3-sym_cleves_means3
...
pheatmap(as.matrix(explc_sym_cleves3),
         color=rev(colorRampPalette(brewer.pal(n=11, name="RdBu"))(20)),
         cluster_rows = T, show_rownames = T, fontsize_row=8, fontsize_col=10, treeheight_row = 10, treeheight_col = 10,
         cluster_cols = T, show_colnames = T, clustering_callback=callback, angle_col= "315", cellheight = 8, cellwidth = 14,
         breaks=c(seq(from=-1,to=1,by=0.1)),
...
bubbleplot_s
#saved as bubbleplot_starv_GOdeltarank.pdf as landscape 9x7 in Figures
```
...
bubbleplot_d
#saved as bubbleplot_def_GOdeltarank as landscape 9x3 in Figures
```
